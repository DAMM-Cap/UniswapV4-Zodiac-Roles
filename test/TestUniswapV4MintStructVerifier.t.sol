...
contract TestUniswapV4MintStructVerifier is Test, IModifier {
    ...
    function test_mint_struct_verifier_invalid_currency0(PositionConfig calldata _config, Currency _invalidCurrency)
        public
    {
        /* ------------------------------------------------------------ *
         *  build Mint params exactly as the hook/condition expects     *
    ...
    function test_mint_struct_verifier_invalid_currency1(PositionConfig calldata _config, Currency _invalidCurrency)
        public
    {
        /* ------------------------------------------------------------ *
         *  build Mint params exactly as the hook/condition expects     *
    ...
    function test_mint_struct_verifier_invalid_owner(PositionConfig calldata _config, address _invalidOwner) public {
        vm.assume(_invalidOwner != avatar());
        /* ------------------------------------------------------------ *
         *  build Mint params exactly as the hook/condition expects     *
         * ------------------------------------------------------------ */
        bytes memory params = abi.encode(_config.poolKey, 0, 0, 0, 0, 0, _invalidOwner, "test");
